...
* CapSense Configurator 1.1.0 build 279
*
********************************************************************************
    ...
    <Widgets>
        <Widget id="Button0" type="CSX_BUTTON">
            <WidgetProperties>
                ...
                <Property id="SNS_CLK_FREQ" value="25000"/>
                <Property id="ROW_SNS_CLK" value="2"/>
                <Property id="ROW_SNS_CLK_FREQ" value="25000"/>
                <Property id="SNS_CLK_SOURCE" value="DIRECT"/>
                <Property id="TX_CLK" value="80"/>
                <Property id="TX_CLK_FREQ" value="625"/>
        ...
        <Widget id="Button1" type="CSX_BUTTON">
            <WidgetProperties>
                ...
                <Property id="SNS_CLK_FREQ" value="3125"/>
                <Property id="ROW_SNS_CLK" value="16"/>
                <Property id="ROW_SNS_CLK_FREQ" value="3125"/>
        ...
        <Widget id="LinearSlider0" type="LINEAR_SLIDER">
            <WidgetProperties>
                ...
                <Property id="SNS_CLK_FREQ" value="1470"/>
                <Property id="ROW_SNS_CLK" value="2"/>
                <Property id="ROW_SNS_CLK_FREQ" value="25000"/>
                <Property id="SNS_CLK_SOURCE" value="DIRECT"/>
                <Property id="TX_CLK" value="2"/>
                <Property id="TX_CLK_FREQ" value="25000"/>
                <Property id="TX_CLK_SOURCE" value="AUTO"/>
